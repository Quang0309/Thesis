...
class FConvEncoder(FairseqEncoder):
    ...
    def __init__(
        ...
        train_mode = torch.tensor(self.training)
        print("TRAIN MODE")
        print(train_mode)
        self.gcn_layer = final_syntatic_gcn.DirectedGCN(embed_dim, 287, train_mode)
    def forward(self, src_tokens, src_lengths, **kwargs):
        ...
        for key, value in kwargs.items():
            ...
            if (key == 'adjTensor'):
                ...
                label = value
            elif (key == 'adjInverseTensor'):
                adj_inv = value
            elif (key == 'labelInverseTensor'):
                label_inv = value
        ...
        x = self.gcn_layer(x,adj, label, adj_inv, label_inv)
...
#     FairseqLanguageModel, register_model, register_model_architecture, final_syntatic_gcn
# )
...
#         print(train_mode)
#         self.gcn_layer = final_syntatic_gcn.DirectedGCN(embed_dim, 287, train_mode)
#         #self.w_adj = torch.empty(embed_dim,embed_dim,requires_grad=True)
#         #nn.init.normal_(self.w_adj, std = 0.01)
